...
# and define some string variables to be used later.
if SWITCH == "homophily":
...
save_fig(f"images/les_miserables/les_miserables_{params}_draw_kmeans_{plot_suffix}.png", h = 10, w = 20, dpi = 200)
plt.show()
