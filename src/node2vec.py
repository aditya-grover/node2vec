...
class ProgressBar():
    ...
    def start(self, max_value, description):
        self.bar.set_description(description)
        self.max_value = max_value
        self.bar = tqdm(total=max_value)
...
class Graph():
    ...
    def preprocess_transition_probs(self):
        ...
        alias_nodes = {}
        self.progress_bar.start(len(G.nodes()), "Preprocessing Nodes")
        for node in G.nodes():
        ...
        self.progress_bar.start(len(G.edges()), "Preprocessing Edges")
        if is_directed:
            for edge in G.edges():
